...
Route::post('/friends/store', [FriendsController::class, 'store']);
...
Route::get('/groups/addmember/{id}', [GroupsController::class, 'addmember']);
Route::put('/groups/addmember/{id}', [GroupsController::class, 'updateaddmember']);
Route::put('/groups/deleteaddmember/{id}', [GroupsController::class, 'deleteaddmember']);
